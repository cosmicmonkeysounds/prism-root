...
let package = Package(
    ...
    targets: [
        ...
        .target(
            ...
            path: "ios/Sources/PrismDaemonPlugin"
        ),
        .testTarget(
            name: "PrismDaemonPluginTests",
            dependencies: ["PrismDaemonPlugin"],
            path: "ios/Tests/PrismDaemonPluginTests"
        ),
    ]
)
