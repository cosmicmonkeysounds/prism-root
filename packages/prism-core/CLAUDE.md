...
- `@prism/core/manifest` — Workspace Manifest (vault identity envelope, StorageConfig, SchemaConfig, SyncConfig, CollectionDef, parse/serialise/validate)
