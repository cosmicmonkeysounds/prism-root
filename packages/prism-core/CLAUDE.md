...
- `@prism/core/undo` — Undo/Redo (UndoRedoManager — snapshot-based undo/redo with merge for rapid edits, batch support, configurable max history, subscribe for UI reactivity)
