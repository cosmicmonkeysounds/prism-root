 ...
 *
 * Mirrors PluginBundle from layer1/plugins/plugin-install.ts. Each bundle
 ...
 *
 * Layer 1 stays React-free: the component type is a type parameter so
 * Studio can specialize with React's ComponentType while core remains
 * pure TypeScript.
 */
