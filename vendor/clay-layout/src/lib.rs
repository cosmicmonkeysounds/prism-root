...
// Vendored upstream code — Prism's workspace clippy policy
// (`-D warnings`) is stricter than upstream's. We don't want to
// patch every cosmetic lint in the fork; mirror upstream's posture
// and silence clippy + the unused-import lint locally.
#![allow(clippy::all)]
