...
//! The render walker (lower_ui pipeline) applies modifiers as wrapper
//! layers around the component's output. The Slint-specific wrap path
//! was deleted with the rest of the Slint emission stack.
