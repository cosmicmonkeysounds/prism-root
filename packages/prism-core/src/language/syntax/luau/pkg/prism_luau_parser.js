/* @ts-self-types="./prism_luau_parser.d.ts" */
 ...
 * @returns {Uint32Array}
 */
export function findStatementLines(source) {
    const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.findStatementLines(ptr0, len0);
    if (ret[3]) {
 ...
 * @returns {any}
 */
export function findUiCalls(source) {
    const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.findUiCalls(ptr0, len0);
    if (ret[2]) {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./prism_luau_parser_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('prism_luau_parser_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
