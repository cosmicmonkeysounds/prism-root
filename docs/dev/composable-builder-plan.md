...
### Wave 11 — `.prism-ui` self-hosting (long tail) — substrates + 11.4 + 11.5 landed; loader seam + 24 Tier-1 migrations + full DSL expression substrate landed 2026-05-12
...
- [~] **11.2** Tier-1 migration: loader seam landed +
  ...
  **one `.prism-ui` source + one row in the table**; the loader
  ...
  - **Batch 3** (this commit, substrate-unblocked): `shell.toast`,
