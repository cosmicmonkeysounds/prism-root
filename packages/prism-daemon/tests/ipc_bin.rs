...
//! format the `prism-studio` desktop shell uses (see
//! `docs/dev/clay-migration-plan.md` §4.5). This is the "confirm
//! spawn / supervise / kill works" half of Phase 0 spike #6.
//!
